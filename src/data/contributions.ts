...
export interface Contribution {
    ...
    language: string;
    type: "pr" | "issue";
    status: "open" | "closed" | "merged" | "resolved";
}
...
export const contributions: Contribution[] = [
    ...
    {
        repo: "spicetify/docs",
        title: "[Bug]: Broken relative link in themes.md: ./marketplace.md should be ./marketplace",
        number: "221",
        url: "https://github.com/spicetify/docs/issues/221",
        description:
            "Signalement d'un lien relatif cassé dans themes.md — `./marketplace.md` causait une 404 sur le site rendu, corrigé en `./marketplace`",
        reason: "L'extension `.md` dans les liens relatifs Docusaurus génère une 404 — le routeur s'attend à un chemin sans extension",
        language: "Markdown",
        type: "issue",
        status: "resolved",
    },
