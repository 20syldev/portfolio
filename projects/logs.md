...
tags: ["Next.js", "Radix UI", "Tailwind CSS", "TypeScript"]
...
L'interface récupère le JSON généré par l'API en temps réel et l'affiche proprement, avec une mise en forme structurée des requêtes.
