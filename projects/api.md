...
Vous pouvez augmenter la limite de requêtes en vous rendant sur la page [pricing](https://docs.sylvain.pro/v3/fr/pricing) de la documentation, et en achetant un jeton d'API.