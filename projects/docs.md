...
Initialement, la documentation était hébergée sur le domaine [api.sylvain.pro](https://api.sylvain.pro), mais j'ai décidé de la déplacer sur un domaine à part pour plusieurs raisons.
