      ...
      <Tooltip.Root>
        ...
        <Tooltip.Portal>
          <Tooltip.Content
            ...
            side="top"
          >
            Ceci est un tooltip accessible avec positionnement automatique
            et support complet du clavier.
          ...
          <Select.Portal>
            <Select.Content className="bg-white rounded shadow-lg border">
              <Select.Viewport className="p-1">
                <Select.Item value="fr" className="px-3 py-2 outline-none hover:bg-gray-100 rounded cursor-pointer flex items-center">
                  <Select.ItemText>France</Select.ItemText>
                  <Select.ItemIndicator className="ml-auto">
                    <CheckIcon />
                  </Select.ItemIndicator>
                </Select.Item>
                <Select.Item value="us" className="px-3 py-2 outline-none hover:bg-gray-100 rounded cursor-pointer flex items-center">
                  <Select.ItemText>États-Unis</Select.ItemText>
                  <Select.ItemIndicator className="ml-auto">
                    <CheckIcon />
                  </Select.ItemIndicator>
                </Select.Item>
                <Select.Item value="uk" className="px-3 py-2 outline-none hover:bg-gray-100 rounded cursor-pointer flex items-center">
